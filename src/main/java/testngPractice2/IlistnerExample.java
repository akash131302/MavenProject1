...
@Listeners(testngPractice2.lListeDemo2.class)
public class IlistnerExample extends  lListeDemo2 {
...
WebElement btn1=driver.findElement(By.xpath("//img[@class='attachment-shop_catalog size-shop_catalog wp-post-image']"));
	 ...
	 public void Clickonbill() throws InterruptedException {
	  ...
	  @Test(description="click the button bill proceed",priority=7)
	  public void ProceedC() {
	   ...
	   @Test(description = "scroll the page",priority=8)
	  ...
	  @Test(description="fill the info for customer",priority=9)
	  public void checkout() throws InterruptedException {
	   ...
	   @Test(description="pay to pyment proceed",priority=10)
	   ...
	   @Test(description="place the customer order",priority=11)
